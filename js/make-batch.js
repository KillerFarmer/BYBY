...
.controller('MakeBatchCtrl', ['$scope', '$http', function($scope, $http) {
    ...
    $scope.addRecipe = function(recipe) {
        if (old_recipe != null) {
            document.getElementById(old_recipe).setAttribute("class", "collection-item avatar black-text");
        }
        batch.recipe = recipe;
        document.getElementById(recipe).setAttribute("class", "collection-item avatar red accent-1 black-text");
        old_recipe = recipe;
